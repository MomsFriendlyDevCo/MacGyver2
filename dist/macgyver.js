(function (Vue$1, $) {
            ...
            */
            ...
            $macgyver.fetch = function (url, options) {
              ...
              .then(function (session) {
                if (!isEmpty_1(session.settings.mappings)) {
                  // Extract mappings
              ...
              .then(function (session) {
                var _ref5, _session$settings;

                var checkRequired = (_ref5 = (_session$settings = session.settings, pickBy_1(_session$settings, function (v, k) {
                  return k.required && !has_1(session.mappings, v);
                })), map_1(_ref5, function (v, k) {
                  return k;
                }));
                ...
                switch (session.settings.type) {
                  case 'array':
                    ...
                    if (!isEmpty_1(session.mappings)) {
                      var pickKeys = map_1(session.settings.mappings, function (v, k) {
                  ...
                  case 'object':
                    ...
                    if (!isEmpty_1(session.mappings)) {
                      var _ref6, _session$mappings;

                      session.output = (_ref6 = (_session$mappings = session.mappings, mapKeys_1(_session$mappings, function (v, k) {
                        return k.replace(/^\$/, '');
                      }) // Remove '$' prefix
                      ), mapValues_1(_ref6, function (v, k) {
            ...
            */
            ...
            Vue$1.prototype.$macgyver = function () {
              var $macgyver$1 = $macgyver; // Absorb various methods from a Vue prototype
              ...
              $macgyver$1.inject = function (component) {
                ...
                if (component.$props.config.$dataPath) {
                  var refresher = function refresher() {
                    component.data = _.get($macgyver$1.$forms[component.$props.form].$props.data, component.$props.config.$dataPath);
                  };
            ...
            var script$7 = Vue.component('mgChoiceDropdown', {
              ...
              created: function created() {
                ...
                this.$watch('$props.config.enum', function () {
                  ...
                  if (_this.data) {
                    _this.value = _this.enumIter.find(function (e) {
                ...
                */
                refreshShowIfs: function refreshShowIfs() {
                  ...
                  this.spec.showIfs.forEach(function (widget) {
                    return widget.show = _this2.$macgyver.utils.evalMatch(widget.showIf, _this2.data);
                  });
                },
