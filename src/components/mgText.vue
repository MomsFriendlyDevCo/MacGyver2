	...
	config: {
		...
		autoComplete: {
			...
			enum: [
				...
				{id: 'adress-level1', title: 'Address level 1'},
				{id: 'adress-level2', title: 'Address level 2'},
				{id: 'adress-level3', title: 'Address level 3'},
				{id: 'adress-level4', title: 'Address level 4'},
